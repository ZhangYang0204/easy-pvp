...
public class CommandSetMapIgnorePartyDamage extends CommandBase {
    public CommandSetMapIgnorePartyDamage(@NotNull CommandSender sender, boolean forcePlayer, @NotNull String[] args) {
    ...
    protected boolean run() {
        ...
        try {
            ...
            commandService.setMapIgnorePartyDamage(args[1], build);
