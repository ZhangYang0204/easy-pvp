...
public class CommandSetMapIsolatePotionEffect extends CommandBase {
    public CommandSetMapIsolatePotionEffect(@NotNull CommandSender sender, boolean forcePlayer, @NotNull String[] args) {
    ...
    protected boolean run() {
        ...
        try {
            ...
            commandService.setMapIsolatePotionEffect(args[1],fair);
