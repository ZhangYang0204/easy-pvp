...
public class CommandSetMapKeepInventory extends CommandBase {
    public CommandSetMapKeepInventory(CommandSender sender, boolean forcePlayer, String[] args) {
    ...
    protected boolean run() {
        ...
        try {
            ...
            commandService.setMapDrop(args[1],drop);
