...
public class CommandSetMapIsolateHealth extends CommandBase {
    public CommandSetMapIsolateHealth(@NotNull CommandSender sender, boolean forcePlayer, @NotNull String[] args) {
    ...
    protected boolean run() {
        ...
        try {
            ...
            commandService.setMapIsolateHealth(args[1],fair);
