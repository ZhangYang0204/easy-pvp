...
public class CommandMapDelete extends CommandBase {


    public CommandMapDelete(CommandSender sender, boolean forcePlayer, String[] args) {
    ...
    protected boolean run() {
        try {
            ...
            List<String> list= MessageYamlManager.MESSAGE_YAML_MANAGER
                    .getCHAT_FAILURE_MAP_DELETE_BECAUSE_NOT_EXIST_MAP_NAME();
