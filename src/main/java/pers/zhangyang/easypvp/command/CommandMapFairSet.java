...
public class CommandMapFairSet extends CommandBase {
    public CommandMapFairSet(CommandSender sender, boolean forcePlayer, String[] args) {
    ...
    protected boolean run() {
        ...
        try {
            ...
            rep.put("{fair}",args[2]);
            List<String> list= MessageYaml.MESSAGE_YAML_MANAGER
                    .getCHAT_FAILURE_MAP_FAIR_SET_BECAUSE_NOT_EXIST_MAP_NAME();
