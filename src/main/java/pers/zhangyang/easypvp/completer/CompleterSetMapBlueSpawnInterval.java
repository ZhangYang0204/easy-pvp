...
public class CompleterSetMapBlueSpawnInterval extends CompleterBase {
    public CompleterSetMapBlueSpawnInterval(@NotNull CommandSender sender, boolean forcePlayer, @NotNull String[] args) {
