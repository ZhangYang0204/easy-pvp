...
public class CompleterSetMapCelebrateTime extends CompleterBase {
    public CompleterSetMapCelebrateTime(@NotNull CommandSender sender, boolean forcePlayer, @NotNull String[] args) {
    ...
    public List<String> complete() {
        ...
        if (args.length==2){
            List<String> list= MessageYaml.MESSAGE_YAML_MANAGER.MESSAGE_YAML_MANAGER.getCOMPLETER_EASY_PVP_SET_MAP_CELEBRATE_TIME();
        ...
        if (args.length==3){
            return removeStartWith(args[2], MessageYaml.MESSAGE_YAML_MANAGER.getCOMPLETER_EASY_PVP_SET_MAP_CELEBRATE_TIME_$()
                    ==null?new ArrayList<>():MessageYaml.MESSAGE_YAML_MANAGER.getCOMPLETER_EASY_PVP_SET_MAP_CELEBRATE_TIME_$()
            );
        }
