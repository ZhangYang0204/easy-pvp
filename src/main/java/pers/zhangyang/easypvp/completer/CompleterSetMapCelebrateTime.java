...
public class CompleterSetMapCelebrateTime extends CompleterBase {
    ...
    public @NotNull List<String> complete() {
        ...
        if (args.length==3){
            return removeStartWith(args[2], MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_CELEBRATE_TIME_$()
                    ==null?new ArrayList<>():MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_CELEBRATE_TIME_$()
            );
        }
