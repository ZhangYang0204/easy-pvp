...
public class CompleterSubtractCumulativeStar extends CompleterBase {
    ...
    public List<String> complete() {
        ...
        if (args.length==3){
            return removeStartWith(args[2], MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SUBTRACT_CUMULATIVE_STAR_$()
                    ==null?new ArrayList<>():MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SUBTRACT_CUMULATIVE_STAR_$()
            );
        }
