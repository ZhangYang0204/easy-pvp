...
public class CompleterSetMapIsolateInventory extends CompleterBase {
    ...
    public List<String> complete() {
        ...
        if (args.length==3){
            return removeStartWith(args[2], MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_ISOLATE_INVENTORY_$()
                    ==null?new ArrayList<>():MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_ISOLATE_INVENTORY_$()
            );
        }
