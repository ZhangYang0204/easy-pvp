...
public class CompleterSetMapRedSpawnInterval extends CompleterBase {
    ...
    public @NotNull List<String> complete() {
        ...
        if (args.length==2){
            List<String> list= MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_RED_SPAWN_INTERVAL();
        ...
        if (args.length==3){
            return removeStartWith(args[2], MessageYaml.INSTANCE.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_RED_SPAWN_INTERVAL_$()
                    ==null?new ArrayList<>():MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_RED_SPAWN_INTERVAL_$()
            );
        }
