...
public class CompleterSetMapIgnorePartyDamage extends CompleterBase {
    ...
    public List<String> complete() {
        ...
        if (args.length==2){
            List<String> list= MessageYaml.INSTANCE.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_IGNORE_PARTY_DAMAGE();
        ...
        if (args.length==3){
            return removeStartWith(args[2], MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_IGNORE_PARTY_DAMAGE_$()
                    ==null?new ArrayList<>():MessageYaml.INSTANCE.getCOMPLETER_EASY_PVP_SET_MAP_IGNORE_PARTY_DAMAGE_$()
            );
        }
